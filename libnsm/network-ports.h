...
enum nsm_nvlink_led_state {
	NSM_NVLINK_LED_0_PERCENT = 0x00,
	NSM_NVLINK_LED_25_PERCENT = 0x01,
	NSM_NVLINK_LED_50_PERCENT = 0x02,
	NSM_NVLINK_LED_75_PERCENT = 0x03,
	NSM_NVLINK_LED_100_PERCENT = 0x04,
	NSM_NVLINK_LED_DISABLED = 0x05,
	NSM_NVLINK_LED_NO_LINK = 0x06,
	NSM_NVLINK_LED_BEACON = 0x07,
	NSM_NVLINK_LED_ERROR = 0x08
};

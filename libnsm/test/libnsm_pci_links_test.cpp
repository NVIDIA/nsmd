...
TEST(queryScalarGroupTelemetryV1, testGoodEncodeRequest)
{
	...
	auto rc = encode_query_scalar_group_telemetry_v1_req(0, device_id, group_index, request);
...
TEST(queryScalarGroupTelemetryV1, testGoodDecodeRequest)
{
	...
	auto rc = decode_query_scalar_group_telemetry_v1_req(request, msg_len,
						       &device_id, &group_index);
...
TEST(queryScalarGroupTelemetryV1Group1, testGoodEncodeResponse)
{
	...
	struct nsm_query_scalar_group_telemetry_v1_group_1_resp *resp =
	    reinterpret_cast<struct nsm_query_scalar_group_telemetry_v1_group_1_resp *>(
		response->payload);
	...
	EXPECT_EQ(sizeof(nsm_query_scalar_group_telemetry_group_1), le16toh(resp->hdr.data_size));
    EXPECT_EQ(data_test.negotiated_link_speed, le32toh(data.negotiated_link_speed));
}
...
TEST(queryScalarGroupTelemetryV1Group1, testGoodDecodeResponse)
{
	std::vector<uint8_t> data_byte{   
	    ...
	    0x00, 0x00, 0x00, 0x00, 0x00, 0x0A, 0x09, 0x08, 0x07, 
	};
    ...
    auto data = reinterpret_cast<nsm_query_scalar_group_telemetry_group_1 *>(data_byte.data());
    auto data_test = data;
...
TEST(queryScalarGroupTelemetryV1Group2, testGoodEncodeResponse)
{
	...
	struct nsm_query_scalar_group_telemetry_v1_group_2_resp *resp =
	    reinterpret_cast<struct nsm_query_scalar_group_telemetry_v1_group_2_resp *>(
		response->payload);
	...
	EXPECT_EQ(NSM_QUERY_SCALAR_GROUP_TELEMETRY_V1, resp->hdr.command);
	EXPECT_EQ(sizeof(nsm_query_scalar_group_telemetry_group_2), le16toh(resp->hdr.data_size));
    EXPECT_EQ(data_test.correctable_errors, le32toh(data.correctable_errors));
}
...
TEST(queryScalarGroupTelemetryV1Group2, testGoodDecodeResponse)
{
    ...
    auto data = reinterpret_cast<nsm_query_scalar_group_telemetry_group_2 *>(data_byte.data());
    auto data_test = data;
    responseMsg.insert(responseMsg.end(), data_byte.begin(),
			    data_byte.end());
	auto response = reinterpret_cast<nsm_msg *>(responseMsg.data());
...
TEST(queryScalarGroupTelemetryV1Group3, testGoodEncodeResponse)
{
	...
	struct nsm_query_scalar_group_telemetry_v1_group_3_resp *resp =
	    reinterpret_cast<struct nsm_query_scalar_group_telemetry_v1_group_3_resp *>(
		response->payload);
	...
	EXPECT_EQ(NSM_QUERY_SCALAR_GROUP_TELEMETRY_V1, resp->hdr.command);
	EXPECT_EQ(sizeof(nsm_query_scalar_group_telemetry_group_3), le16toh(resp->hdr.data_size));
...
TEST(queryScalarGroupTelemetryV1Group3, testGoodDecodeResponse)
{
    ...
    auto data = reinterpret_cast<nsm_query_scalar_group_telemetry_group_3 *>(data_byte.data());
    auto data_test = data;
    responseMsg.insert(responseMsg.end(), data_byte.begin(),
			    data_byte.end());
	auto response = reinterpret_cast<nsm_msg *>(responseMsg.data());
...
TEST(queryScalarGroupTelemetryV1Group4, testGoodEncodeResponse)
{
	...
	struct nsm_query_scalar_group_telemetry_v1_group_4_resp *resp =
	    reinterpret_cast<struct nsm_query_scalar_group_telemetry_v1_group_4_resp *>(
		response->payload);
	...
	EXPECT_EQ(NSM_QUERY_SCALAR_GROUP_TELEMETRY_V1, resp->hdr.command);
	EXPECT_EQ(sizeof(nsm_query_scalar_group_telemetry_group_4), le16toh(resp->hdr.data_size));
...
TEST(queryScalarGroupTelemetryV1Group4, testGoodDecodeResponse)
{
    ...
    auto data = reinterpret_cast<nsm_query_scalar_group_telemetry_group_4 *>(data_byte.data());
    auto data_test = data;
    responseMsg.insert(responseMsg.end(), data_byte.begin(),
			    data_byte.end());
	auto response = reinterpret_cast<nsm_msg *>(responseMsg.data());
	...
	EXPECT_EQ(le32toh(data_test->bad_TLP_cnt),
		  data->bad_TLP_cnt);
}
...
TEST(queryScalarGroupTelemetryV1Group5, testGoodEncodeResponse)
{
	...
	struct nsm_query_scalar_group_telemetry_v1_group_5_resp *resp =
	    reinterpret_cast<struct nsm_query_scalar_group_telemetry_v1_group_5_resp *>(
		response->payload);
	...
	EXPECT_EQ(NSM_QUERY_SCALAR_GROUP_TELEMETRY_V1, resp->hdr.command);
	EXPECT_EQ(sizeof(nsm_query_scalar_group_telemetry_group_5), le16toh(resp->hdr.data_size));
...
TEST(queryScalarGroupTelemetryV1Group5, testGoodDecodeResponse)
{
    ...
    auto data = reinterpret_cast<nsm_query_scalar_group_telemetry_group_5 *>(data_byte.data());
    auto data_test = data;
    responseMsg.insert(responseMsg.end(), data_byte.begin(),
			    data_byte.end());
	auto response = reinterpret_cast<nsm_msg *>(responseMsg.data());
	...
	EXPECT_EQ(le32toh(data_test->PCIeRXBytes),
		  data->PCIeRXBytes);
}

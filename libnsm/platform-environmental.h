...
enum nsm_platform_environmental_commands {
	...
	NSM_PWR_SMOOTHING_GET_FEATURE_INFO_V2 = 0xA7,
	NSM_PWR_SMOOTHING_GET_CURRENT_PROFILE_INFORMATION_V2 = 0xA8,
	NSM_PWR_SMOOTHING_GET_PRESET_PROFILE_INFORMATION_V2 = 0xA9,
	NSM_PWR_SMOOTHING_QUERY_ADMIN_OVERRIDE_V2 = 0xAA
};
...
enum nsm_inventory_property_identifiers {
	...
	MAXIMUM_MODULE_POWER_LIMIT = 18,
	MINIMUM_MODULE_POWER_LIMIT = 19,

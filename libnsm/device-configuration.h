...
enum device_mode_index {
	...
	DEVICE_MODE_DPU_OPERATION_MODE_DPU_OPERATION = 30,
	DEVICE_MODE_MULTI_SOCKET_MODE_PCIE_DEVICE = 40,
	DEVICE_MODE_CONTROLLED_EW_TRAFFIC_MODE_PCIE_DEVICE = 41,
	DEVICE_MODE_PCIE_BIFURCATION_MODE_PCIE_DEVICE = 42,
};

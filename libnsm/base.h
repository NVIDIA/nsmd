...
enum nsm_completion_codes {
	...
	NSM_ERR_INVALID_STATE_FOR_COMMAND = 0x80,
	NSM_ERR_INVALID_REQUEST_TYPE = 0x81,
};
...
enum nsm_reason_codes {
	...
	ERR_PROPERTY_NOT_SUPPORTED = 0x100,
	ERR_LIFESPAN_VOLATILE_NOT_SUPPORTED = 0x101,
	ERR_LIFESPAN_PERSISTENT_NOT_SUPPORTED = 0x102,
	ERR_NO_BOOT_COMPLETE = 0x103,
	ERR_UPDATE_IN_PROGRESS = 0x104,
	ERR_IMAGE_COPY_IN_PROGRESS = 0x105,
	ERR_IMAGE_COPY_COMPLETED = 0x106,
	ERR_FLASH_WEAR_MITIGATION = 0x107,
	ERR_INCOMPLETE_COMPONENT_SET = 0x108
};
...
typedef enum {
	...
	NSM_PCIE_BRIDGE_DEV_ROLE_CX_BLUEFIELD_NIC = 4,

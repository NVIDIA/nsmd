...
class OemCurrentPowerProfileIntf : public CurrentPowerProfileIntf
{
  ...
  public:
    ...
    // sdbusplus::message::object_path activatePresetProfile(uint16_t profileID)
    // override
    // {
    //     lg2::error("activatePresetProfile ProfileId={ID}", "ID", profileID);
    //     SensorManager& manager = SensorManager::getInstance();
    //     auto eid = manager.getEid(device);
    //     lg2::info("activatePresetProfile for EID: {EID} profileID:{ID}",
    //     "EID",
    //               eid, "ID", profileID);
    ...
    //     {
    //         lg2::error(
    //             "activatePresetProfile: encode_set_active_preset_profile_req
    //             failed ProfileId ={ID}. eid={EID}, rc={RC}", "ID", profileID,
    //             "EID", eid, "RC", rc);
    ...
    //     {
    //         lg2::error(
    //             "activatePresetProfile SendRecvNsmMsgSync failed for eid =
    //             {EID} rc = {RC}", "EID", eid, "RC", rc_);
    //         throw sdbusplus::xyz::openbmc_project::Common::Device::Error::
    //             WriteFailure();
    //         return;
    //     }
    ...
    //         lg2::info("activatePresetProfile for EID: {EID} completed ",
    //         "EID",
    //                   eid);
    //     }
    //     else
    //     {
    //         lg2::error(
    //             "activatePresetProfile decode_set_active_preset_profile_resp
    //             failed.eid = {EID}, CC = {CC} reasoncode = {RC}, RC ={A}",
    ...
    //     {
    //         lg2::error(
    //             "applyAdminOverride: encode_apply_admin_override_req failed.
    //             eid={EID}, rc={RC}", "EID", eid, "RC", rc);
    //         throw sdbusplus::xyz::openbmc_project::Common::Device::Error::
    //             WriteFailure();
    //         return;
    //     }
    ...
    //     {
    //         lg2::error(
    //             "applyAdminOverride SendRecvNsmMsgSync failed for eid = {EID}
    //             rc = {RC}", "EID", eid, "RC", rc_);
    //         throw sdbusplus::xyz::openbmc_project::Common::Device::Error::
    //             WriteFailure();
    //         return;
    //     }
    ...
    //     {
    //         lg2::error(
    //             "activatePresetProfile decode_apply_admin_override_resp
    //             failed.eid = {EID}, CC = {CC} reasoncode = {RC}, RC ={A}",
    //             "EID", eid, "CC", cc, "RC", reason_code, "A", rc);
    //         throw sdbusplus::xyz::openbmc_project::Common::Device::Error::
    //             WriteFailure();

                                                        ...
                                                        eid_t eid)
{
    if constexpr (std::is_same_v<IntfType, NsmAssetIntf>)
    {
        ...
        this->pdi().serialNumber(serialHex);
    }
                                                   ...
                                                   const std::string& objPath)
{
    ...
    if (type == baseType)
    {
        ...
        auto associationsObject =
            std::make_shared<NsmIRoTResponder<AssociationDefinitionsIntf>>(
                name, baseType);
        associationsObject->pdi().associations(utils::getAssociations(associations));
    ...
    else if (type == "NSM_Asset")
    {
        ...
        assetObject->pdi().name(assetName);
        assetObject->pdi().manufacturer(assetManufacturer);
    ...
    else if (type == "NSM_Chassis")
    {
        ...
        chassisObject->pdi().type(ChassisIntf::convertChassisTypeFromString(chassisType));
    ...
    else if (type == "NSM_Location")
    {
        ...
        locationObject->pdi().locationType(LocationIntf::convertLocationTypesFromString(locationType));

...
TEST(nsmPort, GoodTest)
{
    ...
    std::string inventoryObjPath = "/xyz/openbmc_project/inventory/system/dummy/dummy_device/Ports";

    nsm::NsmPort portTel(bus, pName, portNum, type, association, inventoryObjPath);
